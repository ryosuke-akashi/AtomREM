...
!!!!XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX!!!
     ...
     &    x_pos,y_pos,z_pos,dx_pe,dy_pe, dz_pe,ddx_pe, ddy_pe, ddz_pe)
         ...
         real(8) :: dx_pe_c(Nwalker,Natoms)
         real(8) :: dy_pe_c(Nwalker,Natoms)
         real(8) :: dz_pe_c(Nwalker,Natoms)
...
!         call calc_Udiff0(Nwalker,Natoms,Nregions,Ncycles, x_pos  , y_pos  , z_pos  ,pe    )
         x_pos_p(:,:) = x_pos(:,:) 
         x_pos_m(:,:) = x_pos(:,:) 
         y_pos_p(:,:) = y_pos(:,:) 
         y_pos_m(:,:) = y_pos(:,:) 
...
!       FOR X:
     ...
     &                         x_pos_p,y_pos,z_pos,dx_pe_c,dy_pe_c, dz_pe_c)

          ddx_pe(:,ina) = dx_pe_c(:,ina)
 
        call calc_Udiff1(Nwalker,Natoms,Nregions, Ncycles,&
     &                         x_pos_m,y_pos,z_pos,dx_pe_c,dy_pe_c, dz_pe_c)

          ddx_pe(:,ina) = ( ddx_pe(:,ina) - dx_pe_c(:,ina) ) / (2 * del) 

!       FOR Y:
        call calc_Udiff1(Nwalker,Natoms,Nregions, Ncycles,&
     &                         x_pos,y_pos_p,z_pos,dx_pe_c,dy_pe_c, dz_pe_c)

          ddy_pe(:,ina) = dy_pe_c(:,ina)

        call calc_Udiff1(Nwalker,Natoms,Nregions, Ncycles,&
     &                         x_pos,y_pos_m,z_pos,dx_pe_c,dy_pe_c, dz_pe_c)

          ddy_pe(:,ina) = ( ddy_pe(:,ina) - dy_pe_c(:,ina) ) / (2 * del)


!       FOR Z:
        call calc_Udiff1(Nwalker,Natoms,Nregions, Ncycles,&
     &                         x_pos,y_pos,z_pos_p,dx_pe_c,dy_pe_c, dz_pe_c)

          ddz_pe(:,ina) = dz_pe_c(:,ina)

        call calc_Udiff1(Nwalker,Natoms,Nregions, Ncycles,&
     &                         x_pos,y_pos,z_pos_m,dx_pe_c,dy_pe_c, dz_pe_c)

          ddz_pe(:,ina) = ( ddz_pe(:,ina) - dz_pe_c(:,ina) ) / (2 * del)
...
!          ddz_pe(:,ina) = (pe_z_p(:) -2d0*pe(:) + pe_z_m(:))/(del*del)
        ...
        call calc_Udiff1(Nwalker,Natoms,Nregions, Ncycles,&
     &                         x_pos,y_pos,z_pos,dx_pe_c,dy_pe_c, dz_pe_c)
